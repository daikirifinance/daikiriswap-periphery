...
import UniswapV2Factory from '@daikiri/daikiriswap-core/build/UniswapV2Factory.json'
import IUniswapV2Pair from '@daikiri/daikiriswap-core/build/IUniswapV2Pair.json'
